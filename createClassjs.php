...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        function createJsClasses($className, $properties) {
            ...
            $jsCreateTemplate .= "      const usuario = {};\n";
            ...
            $jsCreateTemplate .= "                  'Usuário criado com sucesso',\n";
            $jsCreateTemplate .= "                  '',\n";
            $jsCreateTemplate .= "              'success'\n";
            $jsCreateTemplate .= "               )\n";
            $jsCreateTemplate .= "              document.getElementById(\"nome\").value = ''; \n";
            $jsCreateTemplate .= "              document.getElementById(\"email\").value = ''; \n";
            $jsCreateTemplate .= "              document.getElementById(\"senha\").value = ''; \n";
            ...
            $jsCreateTemplate .= "          const user = new Create{$className}();\n";
            $jsCreateTemplate .= "          user.create();\n";
            $jsCreateTemplate .= "  });\n";
            ...
            $jsFetchTemplate .= "           try {\n";
            $jsFetchTemplate .= "                   const response = await fetch('/backend/$className', {\n";
            ...
            $jsFetchTemplate .= "                   this.displayUsers(data);\n";
            ...
            $jsFetchTemplate .= "           }\n";
            $jsFetchTemplate .= "    }\n\n";
            $jsFetchTemplate .= "    displayUsers(data) {\n";
            $jsFetchTemplate .= "    const users = data.usuarios;\n";
            $jsFetchTemplate .= "    const usersDiv = document.getElementById('usersList');\n";
            $jsFetchTemplate .= "       usersDiv.innerHTML = '';\n";
            $jsFetchTemplate .= "       const list = document.createElement('ul');\n";
            $jsFetchTemplate .= "       users.forEach(user => {\n";
        ...
        function createHtmlForm($className, $properties) {
            ...
            $htmlTemplate2 .= "<div id=\"usersList\"></div>\n";
            $htmlTemplate2 .= "</div>\n";
            $htmlTemplate2 .= "<script src=\"js/sweetalert2.all.min.js\"></script>\n";
            $htmlTemplate2 .= "<script src=\"js/getAll.js\"></script> \n";
            $htmlTemplate2 .= "</body>\n";
            $htmlTemplate2 .= "</html>";
